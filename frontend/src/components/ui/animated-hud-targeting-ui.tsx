...
export function TargetingUI({
  ...
  return (
    ...
    >
      ...
      <motion.circle cx="78" cy="66" r=".75" fill={pathColor} initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 1.2, duration: 0.3 }} />
      <motion.circle cx="78" cy="70" r=".75" fill={pathColor} initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 1.3, duration: 0.3 }} />
      <motion.circle cx="82" cy="70" r=".75" fill={pathColor} initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 1.4, duration: 0.3 }} />
      
      <motion.circle cx="159" cy="66" r=".75" fill={pathColor} initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 1.2, duration: 0.3 }} />
      <motion.circle cx="155" cy="70" r=".75" fill={pathColor} initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 1.3, duration: 0.3 }} />
      <motion.circle cx="159" cy="70" r=".75" fill={pathColor} initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 1.4, duration: 0.3 }} />
  ...
  return (
    <div className="relative w-full h-full min-h-screen">
      ...
      >
        ...
        <div
          className={cn("absolute inset-0 w-full h-full bg-cover bg-center bg-no-repeat", backgroundColor ? `bg-[${backgroundColor}]` : "bg-zinc-600/10")}
          style={{
